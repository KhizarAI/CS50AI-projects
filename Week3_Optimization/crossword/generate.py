...
class CrosswordCreator():
    ...
    def enforce_node_consistency(self):
        ...
        """
        # We create a copy of domains to easily itterate and do changes over it.
        domain_copy = copy.deepcopy(self.domains)

        for variable in domain_copy:
            for words in domain_copy[variable]:
    ...
    def ac3(self, arcs=None):
        ...
        if arcs is None:
            arcs = []
            for varaible in self.crossword.variables:
                for neighbour in self.crossword.neighbors(varaible):
                    arcs.append((varaible, neighbour))
            ...
            for neighbor in self.crossword.neighbors(variable):
                if neighbor in assignment.keys():
                    ...
                    if neighbor in assignment:
                        if words[i] != assignment[neighbor][j]:
                            return False
