...
class Sentence():
    ...
    def known_mines(self):
        ...
        # Means if count equal to cells then all the cells are mine because count tells how many mines near it.
        # If at position (3,3) = 3, It means these all are mines {(3,2), (2,2), (2,3)} at this position 
    ...
    def known_safes(self):
        ...
        """
        # If we get count = 0, thats means it near cells are safe
        if self.count == 0:
            return self.cells
        else:
            return set()
    ...
    def mark_mine(self, cell):
        ...
        """
        # If {(1,0), (1,1), (0, 1)} = 2, and I found that (0,1) is a mine,
        # then I remove (0,1) it from the set and the resulting sentence would be {(1,0), (1,1)} = 1
    ...
    def mark_safe(self, cell):
        ...
        """
        # If {(1,0), (1,1), (0, 1)} = 2, and I found that (0,1) is safe or not mine 
        # then I remove (0,1) it from the set and the resulting sentence would be {(1,0), (1,1)} = 2
        if cell in self.cells:
            self.cells.remove(cell)
